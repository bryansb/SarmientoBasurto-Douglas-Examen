...
<html lang="es">
	...
	<head>
		...
		<title>Buscar por Número | Examen</title>
	</head>
	
	<body>
	
		<section class="container" style="margin-top: 50px">
			<h1>Listado por Número</h1>
			
			<div class="row justify-content-center">
				<form class="form-group row" onsubmit="searchByPhone();" method="get">
					<div class="col-10">
						<label for="searchKey">Ingrese un número telefónico:</label>
